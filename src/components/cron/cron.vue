    ...
    <el-row class="cron-row">
      <el-tabs v-model="activeTabName" type="border-card">
        <el-tab-pane name="1">
          ...
          <second :tag="tag.second" :size="size" @second-change="changeSecond" />
        </el-tab-pane>
        <el-tab-pane name="2">
          <span slot="label">{{ $t('minute.title') }}</span>
          <minute :tag="tag.minute" :size="size" @minute-change="changeMinute" />
        </el-tab-pane>
        <el-tab-pane name="3">
        ...
        <el-tab-pane name="8">
          ...
          <div class="cell-div">
            ...
            <el-select v-model="sample" :size="size" :placeholder="$t('common.placeholder')" :filter-method="filterCase" style="min-width: 320px;" filterable>
              <el-option v-for="item in cases" :key="item.value" :label="item.label" :value="item.value">
