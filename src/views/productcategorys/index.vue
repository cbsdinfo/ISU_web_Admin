<template>
  <div class="flex-column productCategorys">
    ...
    <el-dialog class="dialog-mini" @close="closeDialog" width="600px" :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible" :close-on-click-modal="false" :lock-scroll="true">
    ...
    submit() {
      this.$refs["ruleForm"].validate((valid) => {
        if (valid) {
          ...
          this.$api.productCategorys[apiName](this.temp).then(() => {
            this.$swal.fire({
              title: "成功",
              icon: "success",
              timer: 2000,
