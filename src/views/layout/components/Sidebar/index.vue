<template>
  <el-scrollbar wrapClass="scrollbar-wrapper" style="border-right: 1px solid #f5f5f5;">
    <el-menu mode="vertical" :show-timeout="200" :default-active="$route.path" :collapse="isCollapse" router :background-color="themeStatus ? '#304156' : ''" :text-color="themeStatus ? '#bfcbd9' : ''" :active-text-color="themeStatus ? '#409EFF' : '#409eff'">
